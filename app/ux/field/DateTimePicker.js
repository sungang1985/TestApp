 ...
 * @aside guide forms
 *
 * This is a specialized field which shows a {@link TestApp.ux.picker.DateTime} when tapped. If it has a predefined value,
 * or a value is selected in the {@link TestApp.ux.picker.DateTime}, it will be displayed like a normal {@link Ext.field.Text}
...
Ext.define('TestApp.ux.field.DateTimePicker', {
    extend: 'Ext.field.Text',
    alternateClassName: 'Ext.form.DateTimePicker',
    xtype: 'datetimepickerfield',
    requires: [
        'TestApp.ux.picker.DateTime',
        'Ext.DateExtras'
    ],
    ...
    config: {
        ...
        /**
         * @cfg {Object/TestApp.ux.picker.DateTime} picker
         * An object that is used when creating the internal {@link TestApp.ux.picker.DateTime} component or a direct instance of {@link TestApp.ux.picker.DateTime}
         * Defaults to true
         * @accessor
         */
        picker: true,
         ...
         * Default value for the field and the internal {@link TestApp.ux.picker.DateTime} component. Accepts an object of 'year',
    ...
    updateValue: function(newValue) {
        ...
        if (this._picker && this._picker instanceof TestApp.ux.picker.DateTime) {
    ...
    updateDateFormat: function(newDateFormat, oldDateFormat) {
        ...
        if (newDateFormat != oldDateFormat && Ext.isDate(value) && this._picker && this._picker instanceof TestApp.ux.picker.DateTime) {
    ...
    getPicker: function() {
        ...
        if (picker && !picker.isPicker) {
            picker = Ext.factory(picker, TestApp.ux.picker.DateTime);
            picker.on({
                scope: this,
     ...
     * @param {TestApp.ux.picker.DateTime} picker The date picker
